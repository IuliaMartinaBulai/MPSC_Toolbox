% File: ode_generalized_carpobrotus_fourth.m
%
% Goal: This ODE system to be solved, corresponding to the first case
%
% Use: ode_generalized_carpobrotus_fourth(t,y,s,r,H,K,gamma,d_1,a,d_2,b,alpha,beta)
%
% Input: t - time
%        y - variable
...
%--------------------------------------------------------------------------
function [dydt] = ode_generalized_carpobrotus_fourth(t,y,s,r,H,K,gamma,d_1,a,d_2,b,alpha,beta)
